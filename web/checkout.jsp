<%-- 
    Document   : checkout
    Created on : Jul 14, 2021, 8:50:47 PM
    Author     : Admin
--%>
                                                    ...
                                                    <div id="collapseThree" class="panel-collapse collapse">
                                                        <div class="panel-body">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="aa-checkout-single-bill">
                                                                        <input type="text" name="date" placeholder="Date Create">
                                                                    </div>                             
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="aa-checkout-single-bill">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="aa-checkout-single-bill">
                                                                        <input type="text" name="cAddress" placeholder="sAddress">
                                                                    </div>                             
                                                                </div> 
                                                            </div>  
                                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="checkout-right">                                               
                                                        ...
                                                        <div class="aa-order-summary-area">
                                                            ...
                                                            <table class="table table-responsive">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %>
                                                                    <tr>
                                                                        <td><%= pro.getPname()%> <strong> x  <%= count%></strong></td>
                                                                ...
                                                                <tr>
                                                                    <th>Total</th>
                                                                    <td><input type="" name="total" value="<%= subtotal%>"></td>
                                                                </tr>
                                                                </tfoot>
                                                        ...
                                                        <div class="aa-payment-method">                    
                                                            ...
                                                            <input type="hidden" name="service" value="addBillDetail" />
